...
//    @Test
//    void autoGeneartor(){
//        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/filemanager?serverTimezone=UTC&characterEncoding=utf-8", "root", "12345678")
//                .globalConfig(builder -> {
//                    builder.author("sunkai") // 设置作者
//                            .fileOverride() // 覆盖已生成文件
//                            .outputDir("F://workSpace//javaProject//fileManagerJava//src//main//java"); // 指定输出目录
//                })
...
//                    builder.addInclude("files")//配置依照那个表进行逆向生成代码
